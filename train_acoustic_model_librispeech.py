...
if __name__ == "__main__":
    ...
    train_cfg = TrainConfig(
        ...
        batch_size=12,
        num_workers=23,
        train_segments_dir="output/segments/ZeroSylCollapsed-v040-k-9116/LibriSpeech",
        ...
        valid_segments_dir="output/segments/ZeroSylCollapsed-v040-k-9116/LibriSpeech",
