...
class EncodedDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> Tuple[int, torch.Tensor]:
        ...
        if len(segments) < 3 or len(acoustic_units) < 3:
            ...
            idx = torch.randint(0, len(self.segments_paths), (1,)).item()
...
if __name__ == "__main__":
    ...
    train_cfg = TrainConfig(
        ...
        train_segments_pattern="train-clean*/**/*.pt",
        train_acoustic_units_dir="/mnt/wsl/hermione/wavtokenizer/WavTokenizer_small_600_24k_4096/LibriSpeech",
        train_acoustic_units_pattern="train-clean*/**/*.pt",
        ...
        valid_acoustic_units_dir="/mnt/wsl/hermione/wavtokenizer/WavTokenizer_small_600_24k_4096/LibriSpeech",
        valid_acoustic_units_pattern="dev*/**/*.pt",
        lr_init=1e-7,
        lr_max=5e-4,
        lr_final=5e-5,
        n_linear_steps=1600,
